var gamer = 'anonymous';
var testname='mains01';
var correctAnswers = 0;
var xhttp = new XMLHttpRequest();
const startGame = () => {
    var name = String(document.getElementById('userName').value);
    if(name != null && name.length > 2){
        ...
        alert("!!!!Plese Enter your name Properly!!!!!")
    }
};
           ...
           /* if (val == undefined) 
			{
				...
				if (val == questions[currentQuestion].incorrectAnswer) 
				{
					incorrectAnswers++;
				}
				...
				else 
				{
					...
					$('#timer').html("You scored: " + (correctAnswers-incorrectAnswers) + " out of: " + questions.length);
